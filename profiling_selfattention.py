...
input_lengths = [10, 20, 30, 50, 100, 500, 750, 1000,3000, 5000, 6000, 8000, 10000,25000, 30000, 50000, 100000]
num_trials = 10
...
plt.fill_between(df['Input Length'], 
                 ...
                 label='±1 Std Dev')
plt.ylim([0, 0.04])
plt.yticks(np.linspace(0, 0.04, num=10)) 
plt.xlabel('Input Length')
plt.ylabel('Time')
plt.title('Time')
...
plt.tight_layout()
print("plotted")
plt.savefig('my_plot_gpu_with_error_bars.png')
